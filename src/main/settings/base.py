...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST'),  # Or the hostname/IP of your PostgreSQL server
        'PORT': os.getenv('DB_PORT'),  # Default PostgreSQL port, change if different
    }
}
...
AUTH_USER_MODEL = 'users.SaltUser'